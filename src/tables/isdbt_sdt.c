...
typedef struct dvbpsi_isdbt_sdt_decoder_s
{
    DVBPSI_DECODER_COMMON

    dvbpsi_isdbt_sdt_callback     pf_sdt_callback;
    void *                        p_cb_data;

    dvbpsi_isdbt_sdt_t            current_sdt;
    dvbpsi_isdbt_sdt_t *          p_building_sdt;

} dvbpsi_isdbt_sdt_decoder_t;

static void dvbpsi_isdbt_sdt_sections_gather(dvbpsi_t *p_dvbpsi,
                                dvbpsi_decoder_t *p_private_decoder,
                                dvbpsi_psi_section_t * p_section);

static void dvbpsi_isdbt_sdt_sections_decode(dvbpsi_isdbt_sdt_t* p_sdt,
                                dvbpsi_psi_section_t* p_section);

/*****************************************************************************
 * dvbpsi_isdbt_sdt_attach
 *****************************************************************************
 * Initialize a SDT subtable decoder.
 *****************************************************************************/
bool dvbpsi_isdbt_sdt_attach(dvbpsi_t *p_dvbpsi, uint8_t i_table_id, uint16_t i_extension,
                      dvbpsi_isdbt_sdt_callback pf_callback, void* p_cb_data)
{
    assert(p_dvbpsi);
    ...
    dvbpsi_isdbt_sdt_decoder_t*  p_sdt_decoder;

    p_sdt_decoder = (dvbpsi_isdbt_sdt_decoder_t*) dvbpsi_decoder_new(NULL,
                                             0, true, sizeof(dvbpsi_isdbt_sdt_decoder_t));
    if (p_sdt_decoder == NULL)
        return false;

    /* subtable decoder configuration */
    dvbpsi_demux_subdec_t* p_subdec;
    p_subdec = dvbpsi_NewDemuxSubDecoder(i_table_id, i_extension, dvbpsi_isdbt_sdt_detach,
                                         dvbpsi_isdbt_sdt_sections_gather, DVBPSI_DECODER(p_sdt_decoder));
    if (p_subdec == NULL)
    {
...
/*****************************************************************************
 * dvbpsi_isdbt_sdt_detach
 *****************************************************************************
 * Close a SDT decoder.
 *****************************************************************************/
void dvbpsi_isdbt_sdt_detach(dvbpsi_t *p_dvbpsi, uint8_t i_table_id, uint16_t i_extension)
{
    assert(p_dvbpsi);
    assert(p_dvbpsi->p_decoder);
    ...
    dvbpsi_isdbt_sdt_decoder_t* p_sdt_decoder;
    p_sdt_decoder = (dvbpsi_isdbt_sdt_decoder_t*)p_subdec->p_decoder;
    if (p_sdt_decoder->p_building_sdt)
        dvbpsi_isdbt_sdt_delete(p_sdt_decoder->p_building_sdt);
    p_sdt_decoder->p_building_sdt = NULL;
...
/*****************************************************************************
 * dvbpsi_isdbt_sdt_init
 *****************************************************************************
 * Initialize a pre-allocated dvbpsi_isdbt_sdt_t structure.
 *****************************************************************************/
void dvbpsi_isdbt_sdt_init(dvbpsi_isdbt_sdt_t* p_sdt, uint8_t i_table_id, uint16_t i_extension,
...
/*****************************************************************************
 * dvbpsi_isdbt_sdt_new
 *****************************************************************************
 * Allocate and Initialize a new dvbpsi_isdbt_sdt_t structure.
 *****************************************************************************/
dvbpsi_isdbt_sdt_t *dvbpsi_isdbt_sdt_new(uint8_t i_table_id, uint16_t i_extension, uint8_t i_version,
                             bool b_current_next, uint16_t i_network_id)
{
    dvbpsi_isdbt_sdt_t *p_sdt = (dvbpsi_isdbt_sdt_t*)malloc(sizeof(dvbpsi_isdbt_sdt_t));
    if (p_sdt != NULL)
        dvbpsi_isdbt_sdt_init(p_sdt, i_table_id, i_extension, i_version,
                        b_current_next, i_network_id);
    return p_sdt;
}

/*****************************************************************************
 * dvbpsi_isdbt_sdt_empty
 *****************************************************************************
 * Clean a dvbpsi_isdbt_sdt_t structure.
 *****************************************************************************/
void dvbpsi_isdbt_sdt_empty(dvbpsi_isdbt_sdt_t* p_sdt)
{
    dvbpsi_isdbt_sdt_service_t* p_service = p_sdt->p_first_service;

    while (p_service != NULL)
    {
        dvbpsi_isdbt_sdt_service_t* p_tmp = p_service->p_next;
...
/*****************************************************************************
 * dvbpsi_isdbt_sdt_delete
 *****************************************************************************
 * Clean and Delete dvbpsi_isdbt_sdt_t structure.
 *****************************************************************************/
void dvbpsi_isdbt_sdt_delete(dvbpsi_isdbt_sdt_t *p_sdt)
{
    if (p_sdt)
        dvbpsi_isdbt_sdt_empty(p_sdt);
    free(p_sdt);
}

/*****************************************************************************
 * dvbpsi_isdbt_sdt_service_add
 *****************************************************************************
 * Add a service description at the end of the SDT.
 *****************************************************************************/
dvbpsi_isdbt_sdt_service_t *dvbpsi_isdbt_sdt_service_add(dvbpsi_isdbt_sdt_t* p_sdt,
                                           uint16_t i_service_id,
                                           uint8_t i_company_flags,
                                           bool b_eit_schedule,
                                           bool b_eit_present,
                                           uint8_t i_running_status,
                                           bool b_free_ca)
{
    dvbpsi_isdbt_sdt_service_t * p_service;
    p_service = (dvbpsi_isdbt_sdt_service_t*)calloc(1, sizeof(dvbpsi_isdbt_sdt_service_t));
    if (p_service == NULL)
        return NULL;

    p_service->i_service_id = i_service_id;
    p_service->i_company_flags = i_company_flags;
    ...
    {
        dvbpsi_isdbt_sdt_service_t * p_last_service = p_sdt->p_first_service;
...
/*****************************************************************************
 * dvbpsi_isdbt_sdt_service_descriptor_add
 *****************************************************************************
 * Add a descriptor in the SDT service description.
 *****************************************************************************/
dvbpsi_descriptor_t *dvbpsi_isdbt_sdt_service_descriptor_add(
                                               dvbpsi_isdbt_sdt_service_t *p_service,
...
static void dvbpsi_ReInitSDT(dvbpsi_isdbt_sdt_decoder_t* p_decoder, const bool b_force)
{
    assert(p_decoder);
    ...
    if (b_force)
    {
        ...
        if (p_decoder->p_building_sdt)
            dvbpsi_isdbt_sdt_delete(p_decoder->p_building_sdt);
    }
    p_decoder->p_building_sdt = NULL;
}

void reset_isdbt_sdt(dvbpsi_decoder_t* p_decoder)
{
     assert(p_decoder);
     dvbpsi_isdbt_sdt_decoder_t* p_sdt_decoder = (dvbpsi_isdbt_sdt_decoder_t*)p_decoder;
//     if(p_sdt_decoder->p_building_sdt)
//          fprintf(stderr, "******* reset_sdt %d  ",p_sdt_decoder->current_sdt.i_extension);
     dvbpsi_decoder_reset(DVBPSI_DECODER(p_sdt_decoder), true);
}

static bool dvbpsi_CheckSDT(dvbpsi_t *p_dvbpsi, dvbpsi_isdbt_sdt_decoder_t *p_sdt_decoder,
                            dvbpsi_psi_section_t *p_section)
{
    bool b_reinit = false;
    assert(p_dvbpsi);
...
static bool dvbpsi_AddSectionSDT(dvbpsi_t *p_dvbpsi, dvbpsi_isdbt_sdt_decoder_t *p_sdt_decoder,
                                 dvbpsi_psi_section_t* p_section)
{
    assert(p_dvbpsi);
    assert(p_sdt_decoder);
    ...
    if (!p_sdt_decoder->p_building_sdt)
    {
        p_sdt_decoder->p_building_sdt =
                dvbpsi_isdbt_sdt_new(p_section->i_table_id, p_section->i_extension,
...
/*****************************************************************************
 * dvbpsi_isdbt_sdt_sections_gather
 *****************************************************************************
 * Callback for the subtable demultiplexor.
 *****************************************************************************/
void dvbpsi_isdbt_sdt_sections_gather(dvbpsi_t *p_dvbpsi,
                                dvbpsi_decoder_t *p_private_decoder,
                                dvbpsi_psi_section_t * p_section)
{
    assert(p_dvbpsi);
    ...
    dvbpsi_demux_t *p_demux = (dvbpsi_demux_t *)p_dvbpsi->p_decoder;
    dvbpsi_isdbt_sdt_decoder_t *p_sdt_decoder = (dvbpsi_isdbt_sdt_decoder_t*)p_private_decoder;
    /* TS discontinuity check */
    if (p_demux->b_discontinuity)
    {
//        fprintf(stderr, "p_demux->b_discontinuity");
...
//        else
//        {
//            if((p_dvbpsi->p_decoder->b_current_valid) && (p_sdt_decoder->b_current_valid)
...
//                dvbpsi_debug(p_dvbpsi, "SDT decoder", "ignoring already decoded section %d", p_section->i_number);
//                dvbpsi_DeletePSISections2(p_section);
//                fprintf(stderr, "\nignoring already decoded section");
//                return;
//            }
//            else
//            {
//                fprintf(stderr, "\nNEW %d %d %d ",p_sdt_decoder->b_current_valid,p_sdt_decoder->current_sdt.b_current_next , p_section->b_current_next);
//            }
//        }
    }
    ...
    {
        dvbpsi_error(p_dvbpsi, "SDT decoder", "failed decoding section %d", p_section->i_number);
        dvbpsi_DeletePSISections2(p_section);
        return;
    }
    ...
    if (dvbpsi_decoder_psi_sections_completed(DVBPSI_DECODER(p_sdt_decoder)))
    {
        ...
        /* Decode the sections */
        dvbpsi_isdbt_sdt_sections_decode(p_sdt_decoder->p_building_sdt, p_sdt_decoder->p_sections);
        dvbpsi_psi_section_t* p_mysection =  p_sdt_decoder->p_sections;
        bool sdtEquals = true;
        for(int i=0; i<6; i++)
        {
            if(p_mysection)
            {
                p_sdt_decoder->p_building_sdt->i_crcs[i] = ((*(p_mysection->p_payload_end))<<24)+
            ...
            {
                p_sdt_decoder->p_building_sdt->i_crcs[i] = 0;
            }
            if( p_sdt_decoder->current_sdt.i_crcs[i] != p_sdt_decoder->p_building_sdt->i_crcs[i])
            {
                sdtEquals = false;
            }
        }
...
/*****************************************************************************
 * dvbpsi_isdbt_sdt_sections_decode
 *****************************************************************************
 * SDT decoder.
 *****************************************************************************/
void dvbpsi_isdbt_sdt_sections_decode(dvbpsi_isdbt_sdt_t* p_sdt,
                                dvbpsi_psi_section_t* p_section)
{
    ...
    while (p_section)
    {
             ...
             p_byte + 4 < p_section->p_payload_end;)
        {
            ...
            uint8_t i_company_flags = (uint8_t)(p_byte[2] & 0x1c) >> 2;
            ...
            dvbpsi_isdbt_sdt_service_t* p_service = dvbpsi_isdbt_sdt_service_add(p_sdt,
                    i_service_id, i_company_flags, b_eit_schedule, b_eit_present,
            ...
            while(p_byte + 2 <= p_end)
            {
                ...
                if (i_length + 2 <= p_end - p_byte)
                    dvbpsi_isdbt_sdt_service_descriptor_add(p_service, i_tag, i_length, p_byte + 2);
                p_byte += 2 + i_length;
            }
        }
...
/*****************************************************************************
 * dvbpsi_isdbt_sdt_sections_generate
 *****************************************************************************
 * Generate SDT sections based on the dvbpsi_isdbt_sdt_t structure.
 *****************************************************************************/
dvbpsi_psi_section_t *dvbpsi_isdbt_sdt_sections_generate(dvbpsi_t *p_dvbpsi, dvbpsi_isdbt_sdt_t* p_sdt)
{
    ...
    while (p_service != NULL)
    {
        ...
        p_service_start[2] = 0xe0 | ((p_service->i_company_flags & 0x7)<<2) | (p_service->b_eit_schedule  ? 0x2 : 0x0) | (p_service->b_eit_present ? 0x01 : 0x00);
